...
I chose to only include the age adjusted prevalence as it should "eliminate differences in observed rates that result from age differences in population composition." 
...
For more information on the crude vs age-adjusted prevalence check out the [CDC Age adjustment](https://www.cdc.gov/nchs/hus/sources-definitions/age-adjustment.htm#:~:text=Age%2Dadjusted%20rates%20are%20computed,age%20differences%20in%20population%20composition).
