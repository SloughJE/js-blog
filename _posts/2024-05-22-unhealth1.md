...
tags: [Dash App, Portfolio, Project, Tutorial, UnHealth Dashboard]
---
...
This post will be one in a series, explaining the process of creating the dashboard. 

## The Beginning: Finding the Data

Sometimes this is the most difficult part. I spent a lot of time looking through data related to public health. Mostly just Googling and looking through government websites (always fun and straightforward). 
...
<div class="grid-container">
  <div class="grid-item">
    <img src="../assets/blog_img/2024-05-22/scatter_diab_ffoodrest.png" alt="scatterplot">
  </div>
  <div class="grid-item">
    <img src="../assets/blog_img/2024-05-22/hist_obesity.png" alt="histogram">
  </div>
  <div class="grid-item">
    <img src="../assets/blog_img/2024-05-22/map_ffood.png" alt="map">
  </div>
  <div class="grid-item">
    <img src="../assets/blog_img/2024-05-22/scatter_obesity_ffoodexp.png" alt="scatterplot">
  </div>
</div>
...
---
My initial idea was to combine these two datasets in the dashboard and also add some more detailed economic data.
...
<img src="../assets/blog_img/2024-05-22/income.png" alt="Local Image" title="Local Image" style="width:40%;">
...
PLACES was easier to work with, cleaner, and had a lot of information in it. I felt like this would be more than enough for a project dashboard and I wanted to get a 'finished' product out in not too much time. 
...
I usually develop in VSCode. For a data science project I use a [simplified version](https://github.com/SloughJE/template) of the [Cookiecutter Data Science](https://cookiecutter-data-science.drivendata.org/) structure. 
...
Another aspect of this structure is that we can run our pipelines by commands such as:
